(function () {
    ...
    var translations = {
        zh: {
            ...
            'instruction.amount': '手续费由您承担，商家实际到账必须为 {{amount}}，少一分都无法自动确认',
        ...
        'zh-Hant': {
            ...
            'instruction.amount': '手續費由您承擔，商家實際到帳必須為 {{amount}}，少一分都無法自動確認',
        ...
        en: {
            ...
            'instruction.amount': 'You pay the network fee: the merchant must receive exactly {{amount}}, anything less cannot be confirmed automatically',
        ...
        ru: {
            ...
            'instruction.amount': 'Комиссию сети оплачиваете вы: продавец должен получить ровно {{amount}}, меньшая сумма не подтверждается автоматически',
        ...
        vi: {
            ...
            'instruction.amount': 'Bạn chịu phí mạng: người bán phải nhận đúng {{amount}}, thiếu sẽ không được xác nhận tự động',
        ...
        tr: {
            ...
            'instruction.amount': 'Ağ ücretini siz ödersiniz: satıcıya tam olarak {{amount}} ulaşmalı, eksik tutar otomatik onaylanmaz',
        ...
        ja: {
            ...
            'instruction.amount': 'ネットワーク手数料はお客様負担です。販売者の着金額がちょうど {{amount}} である必要があり、不足すると自動確認されません',
        ...
        ko: {
            ...
            'instruction.amount': '네트워크 수수료는 보내는 분 부담입니다. 판매자에게 정확히 {{amount}} 가 입금되어야 하며, 부족하면 자동 확인되지 않습니다',
    ...
    function renderPaymentDetail() {
        ...
        if (amountInstruction) amountInstruction.textContent = t('instruction.amount', {amount: amountText});
